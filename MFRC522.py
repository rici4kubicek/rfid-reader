...
class MFRC522:
    ...
    def MFRC522_Init(self):
        ...
        # io.spiDataTransfer(fd, data, 2)
        #
        self.Write_MFRC522(self.TxModeReg, 0x0)
        self.Write_MFRC522(self.RxModeReg, 0x0)
